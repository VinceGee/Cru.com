...
public class EditTaskFragment extends Fragment implements View.OnClickListener,
    ...
    private void updateViews(){
        ...
        if(task.getReminder() != null){
            ...
            updateReminderDateButtons(AppController.getDefaultReminderDate());
    ...
    public void onClick(View v) {
        ...
        if(v == guiBtnDate){
            ...
            if(AppController.DEBUG) throw new AssertionError("Click from unknown view" + v);
        }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if(isChecked){
            ...
            task.setReminder(AppController.getDefaultReminderDate());
            updateReminderDateButtons(task.getReminder());
        }
        else {
