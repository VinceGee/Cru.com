...
public class EditTaskActivity extends AppCompatActivity implements EditTaskFragment.OnFragmentInteraction {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (id != -1) {
            ...
            int taskPosition = intent.getIntExtra(AppController.INTENT_EXTRA_TASK_LIST_POSITION, Integer.MAX_VALUE);
            taskToEdit = new Task("");
    ...
    public void onTaskChanged(@NonNull final Task task) {
        ...
        if (AppController.DEBUG) Log.d(TAG, "Saved / updated task: " + task.getTitle());
        finish();
    }
