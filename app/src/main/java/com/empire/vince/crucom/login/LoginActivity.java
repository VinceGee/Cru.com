...
import com.empire.vince.crucom.MainActivity;
...
public class LoginActivity extends Activity {
    ...
    @InjectView(R.id.btnLinkToRegisterScreen) Button btnLinkToRegister;
    @InjectView(R.id.resetPwd) Button btnReset;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnReset = (Button) findViewById(R.id.resetPwd);
